      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            <a href="student/course.php" class="nav-link">
          ...
          <li class="nav-item has-treeview">
            <a href="student/test.php" class="nav-link">
          ...
          <li class="nav-item has-treeview">
            <a href="student/project.php" class="nav-link">
          ...
          <li class="nav-item has-treeview">
            <a href="student/assignment.php" class="nav-link">
        ...
        <div class="row">
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              ...
              <a href="student/course.php" class="small-box-footer">Click here <i class="fa fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              <div class="inner">
                <h3>Online Test</h3>
                <p>select subject online for test</p>
              </div>
              <div class="icon">
